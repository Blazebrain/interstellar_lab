...
// Horizontal Spacing
final Widget horizontalSpaceExtraTiny = SizedBox(width: 2.0.w);
...
final Widget horizontalSpaceExtraMedium = SizedBox(height: 32.0.w);
final Widget horizontalSpaceLarge = SizedBox(width: 48.0.w);
final Widget horizontalSpaceExtraLarge = SizedBox(height: 72.w);
final Widget horizontalSpaceExtraExtraLarge = SizedBox(height: 96.w);

// Vertical Spacing
final Widget verticalSpaceExtraTiny = SizedBox(height: 2.0.h);
...
final Widget verticalSpaceExtraMedium = SizedBox(height: 32.0.h);
final Widget verticalSpaceLarge = SizedBox(height: 48.0.h);
final Widget verticalSpaceExtraLarge = SizedBox(height: 72.h);
final Widget verticalSpaceExtraExtraLarge = SizedBox(height: 96.h);
